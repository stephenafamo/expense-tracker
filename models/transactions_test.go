...
func testTransactionToOneTypeUsingType(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	queries.Assign(&local.TypeID, foreign.ID)
	...
	if err = local.L.LoadType(ctx, tx, false, (*[]*Transaction)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.Type == nil {
...
func testTransactionToOneCategoryUsingCategory(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := TransactionSlice{&local}
	if err = local.L.LoadCategory(ctx, tx, false, (*[]*Transaction)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testTransactionToOneSetOpTypeUsingType(t *testing.T) {
	var err error
	...
	for i, x := range []*Type{&b, &c} {
		...
		if !queries.Equal(a.TypeID, x.ID) {
...
func testTransactionToOneRemoveOpTypeUsingType(t *testing.T) {
	var err error
...
func testTransactionToOneSetOpCategoryUsingCategory(t *testing.T) {
	var err error
...
func testTransactionToOneRemoveOpCategoryUsingCategory(t *testing.T) {
	var err error
