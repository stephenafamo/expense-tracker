...
type User struct {
	...
	LastAttemptTime null.Time   `boil:"last_attempt_time" json:"last_attempt_time,omitempty" toml:"last_attempt_time" yaml:"last_attempt_time,omitempty"`
...
var (
	userColumns               = []string{"id", "email", "password", "attempts", "last_attempt_time", "locked", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"email", "password", "updated_at"}
	userColumnsWithDefault    = []string{"id", "attempts", "last_attempt_time", "locked", "created_at"}
