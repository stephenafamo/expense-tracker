...
var (
	userTokenColumns               = []string{"id", "created_at", "updated_at", "deleted_at", "user_id", "token"}
	userTokenColumnsWithoutDefault = []string{"updated_at", "deleted_at", "user_id", "token"}
	userTokenColumnsWithDefault    = []string{"id", "created_at"}
...
func (o *UserToken) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryCockroachDB(dialect, "\"user_tokens\"", updateOnConflict, ret, update, conflict, insert)
...
func (o UserTokenSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UserToken slice provided for delete all")
	}
