...
var (
	userTokenDBTypes = map[string]string{`CreatedAt`: `timestamp with time zone`, `DeletedAt`: `timestamp with time zone`, `ID`: `uuid`, `Token`: `string`, `UpdatedAt`: `timestamp with time zone`, `UserID`: `uuid`}
	_                = bytes.MinRead
)
